...
namespace Smart_Flower_Shop.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public IActionResult GetFlowers(int pageNumber = 1, int pageSize = 5)
        {
            ...
            var flowers = _context.Products
                ...
                .Select(f => new ProductsHomeDto
                {
                    ...
                    Price = f.Price,
                    Quantity = f.Quantity,
                    Occasion = GetDescriptionValue(f.Description, "occasion")
                })
                .ToList();
        ...
        public IActionResult GetProductById(int id)
        {
            var product = _context.Products
                ...
                .Select(p => new ProductDetailsDTO
                {
                    ...
                    Price = p.Price,
                    Quantity = p.Quantity,
                    Occasion = GetDescriptionValue(p.Description, "occasion")
      ...
      /*  [HttpPut("UpdateImage/{id}")]
        ...
        [HttpGet("ByOccasion")]
        public async Task<IActionResult> GetProductsByOccasion(string occasion)
        {
            ...
            var result = products
                .Where(p => MatchesDescriptionValue(p.Description, "occasion", occasion))
                .Select(p => new
                {
                    Id = p.ProductId,
                    p.ImagePath,
        ...
        private static string? GetDescriptionValue(string description, string key)
        {
            ...
            try
            {
                var values = JsonSerializer.Deserialize<Dictionary<string, string>>(description);
        ...
        private static bool MatchesDescriptionValue(string description, string key, string keyword)
        {
            var value = GetDescriptionValue(description, key);
